...
Write-Host "Package with: .\tools\build-track-d-opt-in-release.ps1 -BootstrapRuntimeRoot '$runtimePath' -TesseractLanguagePacks eng,jpn,jpn_vert,chi_sim,chi_sim_vert,tha,kor -SelfContained"
$global:LASTEXITCODE = 0
